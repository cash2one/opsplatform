...
if not django.get_version().startswith('1.6'):
    setup = django.setup()
from opsplatform.api import ServerError, get_object, mkdir
from account.models import User
from asset.models import Asset, AssetGroup
from perm.perm_api import get_asset_info
from perm.models import PermRole
from opsplatform.api import logger, get_role_key, CRYPTOR, bash, get_tmp_dir
from jlog.models import Log, TtyLog
from django.contrib.sessions.models import Session
from perm.perm_api import gen_resource, get_group_asset_perm, get_group_user_perm, user_have_perm, PermRole
from opsplatform.settings import LOG_DIR, NAV_SORT_BY
...
class Nav(object):
    ...
    def print_nav():
        ...
        打印提示导航
        """
        msg = """\n\033[1;32m###    欢迎使用Jumpserver跳板机系统   ### \033[0m
