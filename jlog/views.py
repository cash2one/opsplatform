...
from perm.perm_api import user_have_perm
from django.http import HttpResponseNotFound
from jlog.log_api import renderJSON
from account.models import User
from jlog.models import Log, ExecLog, FileLog, TermLog
from opsplatform.settings import LOG_DIR
import zipfile
import json
import pyte


@require_permission('perm_can_view_log')
...
def log_detail(request):
    return render_to_response('jlog/exec_detail.html', locals(), RequestContext(request))
...
def log_detail(request, offset):
    ...
    if offset == 'exec':
        ...
        try:
            ...
            result = {}
        return render_to_response('jlog/file_detail.html', locals(), RequestContext(request))
