...
from asset.models import Asset, AssetGroup, ASSET_STATUS, ASSET_TYPE, ASSET_ENV, IDC, AssetRecord
from perm.ansible_api import MyRunner
from perm.perm_api import gen_resource
from opsplatform.templatetags.mytags import get_disk_info
