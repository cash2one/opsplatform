...
from asset.asset_api import *
from opsplatform.api import *
# from opsplatform.models import Setting
from asset.forms import AssetForm, IdcForm
from asset.models import Asset, IDC, AssetGroup, ASSET_TYPE, ASSET_STATUS
from perm.perm_api import get_group_asset_perm, get_group_user_perm
from account.models import User
from jlog.models import Log


@require_permission('account.perm_can_add_assetgroup')
def group_add(request):
    ...
    return render_to_response('asset/group_add.html', locals(), RequestContext(request))


@require_permission('account.perm_can_change_assetgroup')
def group_edit(request):
    ...
    return render_to_response('asset/group_edit.html', locals(), RequestContext(request))


@require_permission('account.perm_can_view_assetgroup')
def group_list(request):
    ...
    return render_to_response('asset/group_list.html', locals(), RequestContext(request))


@require_permission('account.perm_can_delete_assetgroup')
...
@require_permission('account.perm_can_add_asset')
def asset_add(request):
    ...
    return render_to_response('asset/asset_add.html', locals(), RequestContext(request))


@require_permission('account.perm_can_add_asset')
def asset_add_batch(request):
    header_title, path1, path2 = u'添加资产', u'资产管理', u'批量添加'
    return render_to_response('asset/asset_add_batch.html', locals(), RequestContext(request))


@require_permission('account.perm_can_delete_asset')
...
@require_permission('account.perm_can_change_asset')
def asset_edit(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error = e.message
            return render_to_response('asset/asset_edit.html', locals(), RequestContext(request))
        return HttpResponseRedirect(reverse('asset_detail')+'?id=%s' % asset_id)

    return render_to_response('asset/asset_edit.html', locals(), RequestContext(request))


@require_permission('account.perm_can_view_asset')
...
def asset_edit_batch(request):
    ...
    if request.method == 'POST':
        ...
        return render_to_response('asset/asset_update_status.html', locals(), RequestContext(request))

    return render_to_response('asset/asset_edit_batch.html', locals(), RequestContext(request))
...
def asset_detail(request):
    ...
    return render_to_response('asset/asset_detail.html', locals(), RequestContext(request))
...
@require_permission('account.perm_can_add_idc')
def idc_add(request):
    """
    IDC add view
    """
    ...
    if request.method == 'POST':
        ...
        if idc_form.is_valid():
            ...
            if IDC.objects.filter(name=idc_name):
                ...
                return render_to_response('asset/idc_add.html', locals(), RequestContext(request))
            else:
                idc_form.save()
...
@require_permission('account.perm_can_view_idc')
def idc_list(request):
    ...
    return render_to_response('asset/idc_list.html', locals(), RequestContext(request))


@require_permission('account.perm_can_change_idc')
def idc_edit(request):
    ...
    if request.method == 'POST':
        ...
        return render_to_response('asset/idc_edit.html', locals(), RequestContext(request))


@require_permission('account.perm_can_delete_idc')
def idc_del(request):
    """
    IDC delete view
    """
