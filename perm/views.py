...
from perm.perm_api import *

from account.models import User
from django.contrib.auth.models import Group
from asset.models import Asset, AssetGroup
from perm.models import PermRole, PermRule, PermSudo, PermPush
# from opsplatform.models import Setting

from perm.utils import gen_keys, trans_all
from perm.ansible_api import MyTask
from perm.perm_api import get_role_info, get_role_push_host
from opsplatform.api import *


@require_permission('account.perm_can_view_permrule')
def perm_rule_list(request):
    ...
    return render_to_response('perm/perm_rule_list.html', locals(), RequestContext(request))
...
def perm_rule_detail(request):
    ...
    return render_to_response('perm/perm_rule_detail.html', locals(), RequestContext(request))


@require_permission('account.perm_can_add_permrule')
def perm_rule_add(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            user_groups_obj = [Group.objects.get(id=group_id) for group_id in user_groups_select]
            ...
            error = e
    return render_to_response('perm/perm_rule_add.html', locals(), RequestContext(request))


@require_permission('account.perm_can_change_permrule')
def perm_rule_edit(request):
    ...
    return render_to_response('perm/perm_rule_edit.html', locals(), RequestContext(request))


@require_permission('account.perm_can_delete_permrule')
...
@require_permission('account.perm_can_view_permrole')
def perm_role_list(request):
    ...
    return render_to_response('perm/perm_role_list.html', locals(), RequestContext(request))


@require_permission('account.perm_can_add_permrole')
def perm_role_add(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = e
    return render_to_response('perm/perm_role_add.html', locals(), RequestContext(request))


@require_permission('account.perm_can_delete_permrole')
...
def perm_role_detail(request):
    ...
    return render_to_response('perm/perm_role_detail.html', locals(), RequestContext(request))


@require_permission('account.perm_can_change_permrole')
...
@require_permission('account.perm_can_role_push')
def perm_role_push(request):
    ...
    return render_to_response('perm/perm_role_push.html', locals(), RequestContext(request))


@require_permission('account.perm_can_view_permsudo')
def perm_sudo_list(request):
    ...
    return render_to_response('perm/perm_sudo_list.html', locals(), RequestContext(request))


@require_permission('account.perm_can_add_permsudo')
def perm_sudo_add(request):
    ...
    try:
        ...
        error = e
    return render_to_response('perm/perm_sudo_add.html', locals(), RequestContext(request))


@require_permission('account.perm_can_change_permsudo')
def perm_sudo_edit(request):
    ...
    try:
        ...
        error = e
    return render_to_response('perm/perm_sudo_edit.html', locals(), RequestContext(request))


@require_permission('account.perm_can_delete_permsudo')
